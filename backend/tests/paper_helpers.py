...
def detail(price: float = 100.0, score: float = 90.0) -> dict[str, Any]:
    return {
        ...
        "spot": {"buy_pressure_5m": 3.0, "sell_pressure_5m": 1.0, "buy_volume_5m": 800.0, "sell_volume_5m": 200.0, "cvd_5m": 600.0},
        "perp": {"buy_pressure_5m": 2.5, "sell_pressure_5m": 1.0, "buy_volume_5m": 400.0, "sell_volume_5m": 100.0, "cvd_5m": 300.0},
